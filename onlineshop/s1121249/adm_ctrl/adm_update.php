...
if ($nStepFlg == 2 && count($arrErr) == 0) {
    ...
    //データ登録
    $bRet = updateMemberadm($sMemberId, $sFirstName, $sLastName, $sPostal, $sAddress, $sTel, $sLoginId, $sLoginPass);
...
//**************************************************
if ($nStepFlg == "") {
    require_once('../adm_view/adm_update.html');
} else if ($nStepFlg == 1) {
    require_once('../adm_view/adm_updateCheck.html');
} else if ($nStepFlg == 2) {
    require_once('../adm_view/adm_updateOK.html');
}
